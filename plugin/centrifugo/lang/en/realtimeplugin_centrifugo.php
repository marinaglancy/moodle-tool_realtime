...
Values for <b>HTTP API key</b>, <b>Token HMAC secret</b> and <b>Host</b> (if present) will be extracted and inserted into the settings form. No other settings will be used or stored. You will need to submit the settings form to save the changes.';
