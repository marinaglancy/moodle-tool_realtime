...
class realtime_tool_form extends \moodleform {
    /**
     * Form to add cahnnel subsciptions
     */
    public function definition() {
        ...
        $mform->setType('area', PARAM_NOTAGS);

        $mform->addElement('text', 'itemid', 'item ID:');
        $mform->setType('itemid', PARAM_NOTAGS);

        $mform->addElement('submit', 'addchannel', 'Add Channel');
        $mform->registerNoSubmitButton('addchannel');
    }
}